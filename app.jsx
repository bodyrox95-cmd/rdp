...
function HomePage({ navigate, showForm }) {
  ...
  { title: 'Листовки и флаеры', sub: 'От 500 шт. Форматы А4, А5, А6', path: '/listovki/', tag: 'Реклама' },
  ...
  const stats = [
  { value: '1860', label: 'год основания' },
  { value: 'Чкалова, 8', label: 'производство в Рыбинске' },
  { value: 'от 500', label: 'экземпляров для офсета' },
  { value: 'Россия', label: 'доставка готовых тиражей' }];
        ...
        <div className="container" style={{ position: 'relative' }}>
          <div style={{ maxWidth: 760 }}>
            ...
            <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap', paddingTop: 32, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
              {[['Книги от 500 экз.', 'офсетная печать'],
              ['от 1 экз.', 'цифровая печать'],
              ['Москва', 'пункт самовывоза'],
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 64, alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ marginBottom: 16 }}>Типография с историей с 1860 года</h2>
              <div className="divider" />
              <p style={{ lineHeight: 1.8, marginBottom: 16 }}>
                Рыбинский дом печати ведёт историю с 1860 года. Тогда предприятие называлось «Первая частная типография И.А. Левикова». Сегодня компания работает как типография полного цикла: от предпечатной подготовки до печати и послепечатной обработки.
              </p>
              <p style={{ lineHeight: 1.8, marginBottom: 24 }}>
                Официальный сайт компании указывает, что производство находится в Рыбинске, на улице Чкалова, 8, а предприятие способно ежемесячно выпускать свыше 400 тысяч книг в твёрдом и мягком переплёте. Работаем с книжной, журнальной, рекламной и деловой полиграфией.
              </p>
              <RouteLink href="/o-kompanii/" navigate={navigate} className="btn-secondary">История и производство</RouteLink>
            </div>
...
function PortfolioPage({ navigate, showForm }) {
  ...
  { label: 'Монография, КБС', meta: 'Тираж 500 экз. · А5 · 320 полос', cat: 'Учебники' },
...
function FAQPage({ navigate }) {
  const allFaq = [
  { q: 'Какой минимальный тираж для офсетной печати?', a: 'Для книг и брошюр — от 500 экземпляров. Для листовок и визиток — от 500 штук. Для меньших объёмов используем цифровую печать.' },
